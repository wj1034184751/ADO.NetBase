...
namespace _32NetSet
{
    public class NetSet_Observer
    {
        public static void Printf()
        {
            Headquarters.Inspector inspector1 = new Headquarters.Inspector("wj first");
            Headquarters.Inspector inspector2 = new Headquarters.Inspector("wj second");
